<?php
echo  $_FILES['personal_pix']['tmp_name'];
echo  "<br>";
echo  "<br>";
echo  "<br>";
echo  "<br>";
...
$uploadPersonalFile = $uploadDir .   $timestamp . '_personal';
$uploadFamilyFile = $uploadDir .   $timestamp . '_family';





$personal_image = time() . "_personal.png";
$personal_temp_image = $_FILES['personal_pix']['tmp_name'];


$family_image = time() . "_family.png";
$family_temp_image = $_FILES['family_pix']['tmp_name'];


if (move_uploaded_file($personal_temp_image, "uploads/" . $personal_image)) {
    echo "Personal Image uploaded successfully.";
} else {
    echo "Error uploading Personal image.";
}


if (move_uploaded_file($family_temp_image, "uploads/" . $family_image)) {
    echo "family Image uploaded successfully.";
} else {
    echo "Error uploading family image.";
}
